...
object NetworkModule {
    ...
    fun makeService(): OwescmRemoteEndPoint {

        val okHttpClient = makeOkHttpClient(makeLoggingInterceptor(), OwescmApplication.getApplicationContext())
        return makeService(okHttpClient, makeGson(), BASE_URL)
    }
    ...
    private fun makeService(okHttpClient: OkHttpClient, gson: Gson, baseUrl: String): OwescmRemoteEndPoint {
        ...
        val retrofit = Retrofit.Builder()
            ...
            .build()
        return retrofit.create(OwescmRemoteEndPoint::class.java)
    }
